 ...
 */
public class YearWithCarPresenter extends BasePresenter implements YearWithCarContract.Presenter{
    private final YearWithCarContract.View mView;

    public YearWithCarPresenter(@NonNull YearWithCarContract.View loginView){
    ...
    @Override
    public void getCarInfoCXDList(String param){
        try {
            OkHttpUtils
                    .postString()
                    .url("http://api.ixiuc.com//api/CarInfo/GetCarInfoCXDList")
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if (dataPackage.getStatusCode() == Constants.OKHTTP_RESULT_SUCESS) {
                                    mView.setGetCarInfoCXDListResult(dataPackage.getBody());
                                } else {
