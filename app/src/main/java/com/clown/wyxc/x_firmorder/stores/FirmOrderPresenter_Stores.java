 ...
 */
public class FirmOrderPresenter_Stores extends BasePresenter implements FirmOrderContract_Stores.Presenter {
    private final FirmOrderContract_Stores.View mView;

    public FirmOrderPresenter_Stores(@NonNull FirmOrderContract_Stores.View loginView){
