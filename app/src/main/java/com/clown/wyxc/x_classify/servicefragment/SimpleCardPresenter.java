...
public class SimpleCardPresenter extends BasePresenter implements SimpleCardContract.Presenter {
    ...
    @Override
    public void getGoodsByGoodsType(String param){
        try {
            OkHttpUtils
                    .postString()
                    .url("http://api.ixiuc.com//api/Goods/GetGoodsByGoodsType")
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if (dataPackage.getStatusCode() == Constants.OKHTTP_RESULT_SUCESS) {
                                    mView.setGetGoodsByGoodsTypeResult(dataPackage.getBody());
                                } else {
