...
public class ShopCarActivity extends BaseAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ShopCarFragment shopcarFragment = (ShopCarFragment) getSupportFragmentManager().findFragmentById(R.id.contentFrame);

            if (shopcarFragment == null) {
                shopcarFragment = ShopCarFragment.newInstance();

                ActivityUtils.addFragmentToActivity(getSupportFragmentManager(),
                        shopcarFragment, R.id.contentFrame);
            }

            // Create the presenter
            new ShopCarPresenter(shopcarFragment);
