 ...
 */
public class CarWithYearPresenter extends BasePresenter implements CarWithYearContract.Presenter{
    private final CarWithYearContract.View mView;

    public CarWithYearPresenter(@NonNull CarWithYearContract.View loginView){
    ...
    @Override
    public void getCarInfoYearList(String param){
        try {
            OkHttpUtils
                    .postString()
                    .url("http://api.ixiuc.com//api/CarInfo/GetCarInfoYearList")
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if (dataPackage.getStatusCode() == Constants.OKHTTP_RESULT_SUCESS) {
                                    mView.setGetCarInfoYearListResult(dataPackage.getBody());
                                } else {
