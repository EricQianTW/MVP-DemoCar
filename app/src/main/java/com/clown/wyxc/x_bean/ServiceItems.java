...
public class ServiceItems extends Message{
    ...
    public ServiceItems(Integer id,String name,String pic,String simpleDetail,String detail,Integer parentId,Integer sort,BigDecimal price,Integer canPay){
        this.id=id;
        this.name=name;
        this.pic=pic;
        this.simpleDetail=simpleDetail;
