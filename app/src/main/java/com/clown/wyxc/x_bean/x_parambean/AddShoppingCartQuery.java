...
public class AddShoppingCartQuery extends Message{ 
    ...
    public AddShoppingCartQuery(){
    }

    public AddShoppingCartQuery(Integer userId,Integer actualGoodsId,Integer goodsNum){
        this.userId=userId;
        this.actualGoodsId=actualGoodsId;
        this.goodsNum=goodsNum;
    }
